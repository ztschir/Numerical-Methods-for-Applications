...
int main() {
  ...
  A(0,0)= 30; A(0,1)=-11.547; A(0,2)= 0; A(0,3)= 0; 
  A(1,0)=-11.547; A(1,1)= 11.667; A(1,2)=-6.124; A(1,3)= 0;
  A(2,0)= 0; A(2,1)=-6.124; A(2,2)= 15; A(2,3)=-4.743; 
  A(3,0)= 0; A(3,1)= 0; A(3,2)=-4.743; A(3,3)= 3; 
